...
const Sidebar = () => {
    ...
    const navItem = [
        ...
        role === "Admin" ?
            { name: "Employee", href: "/employee", icon: User2Icon } :
    ...
    return (
        <>
            ...
            <button>
                <MenuIcon onClick={() => setMobileOpen(true)} size={20} className='lg:hidden fixed top-4 left-4 z-50 p-2 bg-slate-900 text-white rounded-lg shadow-lg border border-white/10' />
            </button>
