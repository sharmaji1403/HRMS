...
const LoginForm = ({ role, title, subtitle }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex justify-center items-center p-6 sm:p-12 bg-white">
        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          <form action="" className="space-y-5" onSubmit={handleSubmit}>
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-2" htmlFor="">Email address</label>
            ...
            <button type="submit" disabled={loading} className="w-full py-3 bg-linear-to-r from-indigo-600 to-indigo-500 text-white rounded-md text-sm font-semibold hover:from-indigo-700 hover:to-indigo-600 disabled:opacity-50 transition-all duration-200 show-lg shadow-indigo-500/25 active:scale-[0.98] flex items-center justify-center">
